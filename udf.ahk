; #### SAMP UDF R18 ####
; SAMP Версия: 0.3.7, 0.3.7-R2, 0.3.DL
; ####################
...
; #     - GetPlayerName()                           Выводит твой ник                                  				            #
; #     - GetPlayerId()                             Выводит твой id                                    						    #
; #     - SendChat(Текст)                           Отправка сообщения в чат не открывая его(через память)        		        #
; #     - AddChatMessage(Текст)                     Отправить фейк сообщение в чат            								    #
; #     - ShowGameText(Текст, Время, Тип текста)    Показать GUI текст                             							    #
; #     - PlayAudioStream(wUrl)                     Проигрывает песню по url                                     			    #
; #     - StopAudioStream()                         Останавливает проигрывание                                       		    #
; #     - GetChatLine(Линия, Вывод)       		    Вывод строки из чат лога (Line=0 - Это последняя строка)					#
; #																				(Output - вывод текста)                         #
...
; #                                                                                                                             #
; ###############################################################################################################################
; # SAMP Функции Диалога (v0.3.7):                                                                                              #
; # --------------------------------------------------------------------------------------------------------------------------- #
; #                                                                                                                             #
; #     - IsDialogOpen()                            Если открыт диалог 1, если не открыт 0                                      #
; #     - GetDialogStyle()                          Стиль диалога 0-5                                                           #
; #     - GetDialogId()                             id диалога                                                                  #
; #     - SetDialogId(id)                           Установить id диалогу                                                       #
; #     - GetDialogIndex()                          Вывод выбраной линии (число)                                                #
...
; #     - IsDialogButton1Selected()                 Проверяет, выбран ли Button1 в диалоговом окне                              #
; #     - GetDialogStructPtr()                      Читает базовый указатель на структуру диалога (используется внутри)         #
; #     - ShowDialog(Стиль, Заголовок,              показать диалоговое окно                                                    #
; #                   Текст, 1Кнопка,																				            #
; #					 2Кнопка(по желанию), id)                                                                                   #
; #                                                                                                                             #
; ###############################################################################################################################
...
; #     - GetIdByPed(dwId)                          id по таргету (getIdByPed(getTargetPed()))                                  #
; #     - GetStreamedInPlayersInfo()                Получить информацию об игроках в радиусе стрима                             #
; #														(какого стрима я ток и не понял)                                        #
...
; #     - CalcScreenCoords(fX, fY, fZ)              Возвращает массив координат [fX,fY,fZ] относительно экрана                  #
; #                                                                                                                             #
; ###############################################################################################################################
; # Функции автомобиля:                                                                                                         #
; # --------------------------------------------------------------------------------------------------------------------------- #
...
; #     - GetPlayerRadiostationId()                 id радиостанции в автомобиле                                                #
; #     - GetPlayerRadiostationName()               Название радиостанции в автомобиле                                          #
; #     - GetVehicleNumberPlate()                   Находит номерной знак автомобиля                                            #
; #                                                                                                                             #
; ###############################################################################################################################
; # Станция Создание:                                                                                                           #
; # --------------------------------------------------------------------------------------------------------------------------- #
; #                                                                                                                             #
; #     - GetPlayerCoordinates()                    Определяет текущую позицию (координаты)                                     #
...
; #     - GetCurrentZonecode()                      Получить текущую зону в краткой форме (удалено, потому что она не работает) #
...
; # --------------------------------------------------------------------------------------------------------------------------- #
; #                                                                                                                             #
; #     - AntiCrash()                               Помогает предотвратить сбой с кодами предупреждения                         #
; #                                                                                                                             #
; ###############################################################################################################################
; # Функции хранения (используются внутри):                                                                                     #
; # --------------------------------------------------------------------------------------------------------------------------- #
; #                                                                                                                             #
; #     - checkHandles()                                                                                                        #
; #     - refreshGTA()                                                                                                          #
